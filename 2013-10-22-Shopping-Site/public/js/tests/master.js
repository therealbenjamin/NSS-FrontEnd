...
test('Product Pagination', function(){
  ...
  equal(db.pagination.perPage, 5, 'should have 5 products per page');
  equal(db.pagination.currentPage, 1, 'should be on page 1');
  ...
  equal(db.pagination.currentPage, 2, 'should be on page 2');
  equal($('#products tr').length, 6, 'should have 5 products in table');
  ...
  equal(db.pagination.currentPage, 3, 'should be on page 3');
...
test('Add Customer', function(){
  ...
  $('#customer-image').val('ipad-air.png');
  $('#customer-name').val('Ipad Air');
  $('#product-weight').val('1.0');
  $('#product-price').val('500.00');
  $('#product-off').val('10');
  $('#add-product').trigger('click');
